...
const cardSchema = z.object({
  ...
  buildTime: z.string().trim().max(40).optional(),
  ...
  primaryLanguage: z.string().trim().max(30).optional(),
  whyBuilt: z.string().trim().max(180).optional(),
  hardestPart: z.string().trim().max(180).optional(),
  whatLearned: z.string().trim().max(180).optional(),
  repoUrl: optionalUrl,
